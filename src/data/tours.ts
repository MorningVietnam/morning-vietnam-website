...
export const tours: Tour[] = [
  ...
  // ── Sa Pa · Lai Châu ──────────────────────────────────────────────────────
  {
    ...
    highlights: [
      ...
      "Overnight homestay at Sì Thâu Chải Village — Dao village",
    ...
    included: [
      ...
      "Homestay at Homestay A Pao · Sì Thâu Chải Village",
    ...
    itinerary: [
      ...
      },
      {
        ...
        slots: [
          ...
          "17:45 Sunset at Sì Thâu Chải Village",
      ...
      },
      {
        ...
        slots: [
          "07:00 Morning in Sì Thâu Chải Village — a Dao village above the clouds",
    ...
    tripInfo: {
      "hanoi-car": [
        ...
        { icon: "home",            label: "Accommodation",     value: "Homestay A Pao · Sì Thâu Chải Village" },
    ...
    valueAnchor: {
      ...
      paragraphs: [
        "There is no Klook listing for O Quy Hồ. No GetYourGuide page for Sì Thâu Chải Village. The glass bridge at Rồng Mây only opened in 2023 and still has no English-language operator running it properly. We built this route because the northwest deserves better than what the standard Sapa circuit offers.",
    ...
    storytelling: {
      ...
      paragraphs: [
        ...
        "O Quy Hồ is only 45 kilometres from Sa Pa. But it might as well be a different country. The pass closes to coaches in bad weather. The villages on the Lai Châu side don't have gift shops — because gift shops require foot traffic, and foot traffic requires a road that buses can use. The homestay at Sì Thâu Chải Village doesn't have a check-in desk. The family just sets the table.",
    ...
    elevationProfile: [
      ...
      { time: "17:45", label: "Sì Thâu Chải Village · Sunset",   elevation: 1450, icon: "hike",     highlight: true,  day: 1 },
    ...
    activityCards: [
      ...
      },
      {
        ...
        time: "17:45 – 07:00",
        title: "Sì Thâu Chải Village — Dao Village Overnight",
  ...
  // ── Lai Châu Loop ────────────────────────────────────────────────────────
  {
    ...
    description: "Three days through a Northwest of Vietnam most tours skip — Sìn Hồ's high roads, Mường Lay's flooded-valley lake town, the stone plateau of Tủa Chùa, a boat crossing on the Da River, and Sì Thâu Chải Village at sunset. Thai, H'Mông, and Red Dao in one loop.",
    highlights: [
      ...
      "Sì Thâu Chải Village — Red Dao village at 1,450m",
      "Two waterfalls, two landscapes: Thác Bay (Sìn Hồ) and Thác Tác Tình",
    ],
    included: [
      "Transport Hanoi → Tam Đường (overnight van, Day 0) and Sì Thâu Chải Village → Hanoi (overnight, Day 3)",
      "All meals: 3 breakfasts · 3 lunches · 3 dinners",
      "2 nights accommodation: Thai family homestay (Mường Lay) + Pa Phông bridge homestay",
      "Boat transfer on the Da River lake (Day 3 morning)",
      "Local guide and Morning Vietnam host",
      "Fishing equipment for evening activity (Day 1, optional)",
      "Morning Vietnam welcome pack",
    ],
    hub:        "Hanoi",
    languages:  ["EN", "FR", "DE"],
    comingSoon: false,
    ...
    gallery: [
      ...
      { src: "/tours/lai-chau-loop/6.webp",  alt: "Red Dao women at Sì Thâu Chải Village village — embroidered headdress and traditional dress" },
      { src: "/tours/lai-chau-loop/7.webp",  alt: "Boat crossing the Da River reservoir — drowned valley between Điện Biên and Lai Châu" },
      { src: "/tours/lai-chau-loop/8.webp",  alt: "San Thàng cultural market at dawn — local produce and Thai minority vendors" },
      ...
      { src: "/tours/lai-chau-loop/15.webp", alt: "Sì Thâu Chải Village village at 1,450m — Red Dao settlement with Lai Châu valley below" },
    ...
    durationOptions: [
      {
        ...
        price:    161,
        priceVND: 4200000,
        tagline:  "Hanoi → Tam Đường · Sìn Hồ · Mường Lay · Tủa Chùa · Pa Phông · Da River Boat · Sì Thâu Chải Village → Hanoi",
        ctaLabel: "I'm in →",
        ctaNote:  "No payment now · Pay 14 days before · Free cancellation until then",
        waText:   "Hi Morning Vietnam — I'd like to book the Lai Châu Loop (3D2N, self-ride)",
        paxTiers: [
          { min: 1,  max: 2,  price: 161, priceVND: 4200000, note: "This trip joins an existing group — we depart once at least 3 guests confirm the same date." },
          { min: 3,  max: 5,  price: 161, priceVND: 4200000 },
          { min: 6,  max: 9,  price: 149, priceVND: 3900000 },
          { min: 10, max: 14, price: 141, priceVND: 3690000 },
        ],
      },
      {
        id:       "easy-rider",
        ...
        paxTiers: [
          { min: 1,  max: 2,  price: 207, priceVND: 5400000, note: "This trip joins an existing group — we depart once at least 3 guests confirm the same date." },
          { min: 3,  max: 5,  price: 207, priceVND: 5400000 },
          { min: 6,  max: 9,  price: 199, priceVND: 5200000 },
          { min: 10, max: 14, price: 197, priceVND: 5130000 },
        ],
      },
    ],
    ...
    tripInfo: {
      "self-ride": [
        { icon: "map-pin",         label: "Pickup",     value: "Hanoi · Sa Pa · or Hà Giang" },
        { icon: "users",           label: "Group size", value: "Max 14 people · private departure from 3+" },
        { icon: "car",             label: "Transport",  value: "Self-ride motorbike or easy-rider" },
        { icon: "tools-kitchen-2", label: "Meals",      value: "Breakfast · Lunch · Dinner — all 3 days" },
        { icon: "home",            label: "Sleep",      value: "Local homestay × 2 nights" },
        { icon: "mountain",        label: "Terrain",    value: "National/Provincial road · Mountain roads · Stone plateau · Da River · Highland forest" },
        { icon: "users",           label: "Cultures",   value: "3 ethnic groups: Thai · H'Mông · Red Dao" },
        { icon: "fish",            label: "Activity",   value: "Evening trap & net fishing on the Da River lake · optional · Day 1" },
      ],
      "easy-rider": [
        { icon: "map-pin",         label: "Pickup",     value: "Hanoi · Sa Pa · or Hà Giang" },
        { icon: "users",           label: "Group size", value: "Max 14 people · private departure from 3+" },
    ...
    pitch: {
      ...
      bullets: [
        ...
        "Tủa Chùa stone plateau (Điện Biên): bare limestone karst at 1,300m — the Northwest of Vietnam that looks nothing like the postcards",
    ...
    valueAnchor: {
      "self-ride": {
        headline: "Three days through a Northwest of Vietnam most tours never reach.",
        paragraphs: [
    ...
    storytelling: {
      headline: "Mường Lay — the town that moved when the water rose.",
      paragraphs: [
        ...
        "The stone plateau of Tủa Chùa, across the Điện Biên border, is the other face of this route. Where most of Northwest of Vietnam is layered green — terraced fields, forested ridges, morning mist — Tủa Chùa is bare limestone and karst at 1,300m. The H'Mông communities here have farmed this soil for generations. The Tả Phìn plateau road is one of the most distinctive driving stretches in the northern highlands.",
        "Sì Thâu Chải Village at the end of Day 3 is a Red Dao village at 1,450m above the Lai Châu valley. The Red Dao are distinct from the H'Mông communities closer to Sa Pa — embroidery more intricate, medicinal plant knowledge deeper, the herbal bath tradition a functional daily practice rather than a wellness product. The sunset from the village looks west across the Lai Châu basin. The van departs for Hanoi at 22:00.",
      ],
      pullImage: "/tours/lai-chau-loop/storytelling.webp",
    },

    elevationProfile: [
      { time: "22:00", label: "Depart Hanoi",                  elevation: 12,   icon: "van",      highlight: false, day: 0 },

      { time: "07:00", label: "Tam Đường · freshen up",        elevation: 900,  icon: "resort",   highlight: false, day: 1 },
      { time: "07:30", label: "San Thàng market · breakfast",  elevation: 880,  icon: "food",     highlight: false, day: 1 },
      { time: "09:00", label: "Đình Cát Chùa Sì",              elevation: 1200, icon: "landmark", highlight: false, day: 1 },
      { time: "10:30", label: "Thác Bay · Sìn Hồ",             elevation: 1450, icon: "hike",     highlight: true,  day: 1 },
      { time: "12:00", label: "Lunch · Sìn Hồ",                elevation: 1500, icon: "food",     highlight: false, day: 1 },
      { time: "15:30", label: "Cầu Lai Hà · Cầu Hang Tôm",    elevation: 290,  icon: "landmark", highlight: false, day: 1 },
      { time: "17:00", label: "Sunset · Mường Lay",             elevation: 265,  icon: "resort",   highlight: true,  day: 1 },
      { time: "20:00", label: "Fishing on the lake (opt.)",     elevation: 265,  icon: "hike",     highlight: false, day: 1 },
      ...
      { time: "07:30", label: "Pa Phông · morning photos",      elevation: 380,  icon: "hike",     highlight: false, day: 3 },
      { time: "09:00", label: "Boat · Da River lake",           elevation: 265,  icon: "van",      highlight: true,  day: 3 },
      { time: "11:30", label: "Lao Chải 1 · lunch",             elevation: 1160, icon: "food",     highlight: false, day: 3 },
      { time: "14:00", label: "Thác Tác Tình",                  elevation: 1000, icon: "hike",     highlight: false, day: 3 },
      { time: "17:00", label: "Sì Thâu Chải Village · sunset",         elevation: 1450, icon: "resort",   highlight: true,  day: 3 },
      { time: "22:00", label: "Depart → Hanoi",                 elevation: 1450, icon: "van",      highlight: false, day: 3 },
    ],
    ...
    activityCards: [
      // ── Day 1 ──────────────────────────────────────────────────────────────
      {
        badgeLabel: "Drive",
        time: "Morning · Day 1",
        title: "San Thàng Market & the Cát Chùa Sì Road to Sìn Hồ",
        desc: "The day starts at Tam Đường — freshen up, leave luggage collected on the final day, and take breakfast at San Thàng cultural market. Then the road climbs toward Sìn Hồ via Cát Chùa Sì — a high ridge section where the mountain views open wide across the northwestern plateau. Stop at Đình Cát Chùa Sì, a communal house set against the mountain face, before continuing upward.",
        highlight: false,
      },
      {
        badgeLabel: "Trek",
        time: "Late Morning · Day 1",
        title: "Thác Bay Waterfall — Into the Sìn Hồ Forest",
        desc: "Thác Bay sits inside primary jungle at around 1,450m — the kind of stop you drive past unknowingly if nobody tells you to pull over. The surrounding forest is dense, the waterfall set back from the road. Lunch at a local restaurant in Sìn Hồ town before the long descent to Mường Lay.",
        highlight: true,
      },
      {
        badgeLabel: "Drive",
        time: "Afternoon · Day 1",
        title: "Descent to Mường Lay — Bridges, Lake, and the Da River",
        desc: "The road drops from Sìn Hồ (1,500m) to Mường Lay (265m) — mountain forest giving way to the Da River reservoir. Stops at Cầu Lai Hà and Cầu Hang Tôm: two bridge viewpoints above the lake where you see the flooded valley and the villages on the opposite slope. Arrive Mường Lay as the light shifts.",
        highlight: false,
      },
      {
        badgeLabel: "Food",
        time: "Evening · Day 1",
        title: "Sunset on the Da River + Thai Fishing (Optional)",
        desc: "Sunset on the Mường Lay reservoir — calm, wide, unhurried. Dinner is Thai cuisine at the homestay. After dinner: optional thả đó and thả lưới — traditional trap and net fishing on the lake with local Thai fishermen. Around 1.5 hours on the water. Not a demonstration; a working night out on the lake.",
        highlight: true,
      },
      // ── Day 2 ──────────────────────────────────────────────────────────────
      {
      ...
      },
      {
        ...
        title: "Tủa Chùa — The Stone Plateau",
        desc: "Tủa Chùa is where the Northwest of Vietnam landscape changes completely. Green terraces give way to bare limestone karst — a high plateau at 1,300m where rock surfaces replace most topsoil. The Tả Phìn plateau road runs through H'Mông settlements between stone formations. It looks nothing like the Northwest of Vietnam in any brochure.",
        highlight: true,
      },
      {
        badgeLabel: "Trek",
      ...
      },
      {
        badgeLabel: "Food",
        time: "Sunset · Day 2",
        title: "Pa Phông Suspension Bridge — Sunset and Overnight",
        desc: "The final stop of Day 2 is the suspension bridge at Pa Phông, above the Da River lake. The homestay is a working family home at a viewpoint that catches the last light across the reservoir. Dinner: Da River specialties — river fish, local vegetables, rice wine if you want it. Sleep beside the lake.",
        highlight: true,
      },
      // ── Day 3 ──────────────────────────────────────────────────────────────
      {
        badgeLabel: "Trek",
        time: "Morning · Day 3",
        title: "Pa Phông Flycam Point + Boat Across the Da River Lake",
        desc: "The Pa Phông bridge at first light — mist over the reservoir, mountain ridges emerging in layers. Time for photography and drone shots before departure. Then the boat: a crossing of the Da River lake along the waterway between Điện Biên and Lai Châu provinces, through a submerged valley accessible only by water.",
        highlight: true,
      },
      {
        badgeLabel: "Food",
        time: "Midday · Day 3",
        title: "Lao Chải 1 — Community Tourism Village, Lunch at the River",
        desc: "Lao Chải 1 is a community-based tourism village with local food, craft products, and a setting at the river's edge. Lunch is regional: fish from the lake, greens from the terraces, cooked by the village. A full stop — not a transit point.",
        highlight: false,
      },
      {
        badgeLabel: "Trek",
        time: "Afternoon · Day 3",
        title: "Tác Tình Waterfall - Hidden Gem in the Forest",
        desc: "Thác Tác Tình drops through a forest clearing at 1,000m, accessible by a short trail from the road. The pool at the base is cold and clear, the surrounding jungle dense. The road at this hour is quiet enough that you often have it to yourselves.",
        highlight: false,
      },
      {
        badgeLabel: "Food",
        time: "Sunset & Evening · Day 3",
        title: "Sì Thâu Chải Village — Red Dao Village, Dinner, Return to Hanoi",
        desc: "The last stop: Sì Thâu Chải Village, a Red Dao village at 1,450m. Sunset looks west across the Lai Châu basin. Dinner with the community — local dishes, sing and dance with locals, Red Dao embroidery and herbal traditions up close. The van departs for Hanoi at 22:00.",
        highlight: true,
      },
    ],
    ...
    itinerary: [
      {
        day: 0,
        title: "Day 0 — Hanoi Overnight Departure",
        slots: [
          "22:00  Depart Hanoi · overnight van to Tam Đường",
        ],
      },
      {
        day: 1,
        title: "Day 1 — Tam Đường → Sìn Hồ → Thác Bay → Cát Chùa Sì → Mường Lay   150km",
        slots: [
          "07:00  Arrive Tam Đường · freshen up · leave luggage (collected Day 3)",
          "07:30  Breakfast at San Thàng cultural market",
          "08:30  Depart toward Sìn Hồ via Cát Chùa Sì — high mountain road",
          "09:00  Đình Cát Chùa Sì — panoramic mountain viewpoint",
          "10:30  Thác Bay waterfall · Sìn Hồ",
          "12:00  Lunch in Sìn Hồ town (~1,500m)",
          "13:00  Depart Sìn Hồ → Mường Lay — long descent",
          "15:30  Cầu Lai Hà · Cầu Hang Tôm — Da River lake viewpoints",
          "17:00  Arrive Mường Lay · sunset on the Da River",
          "18:30  Dinner — Thai cuisine at homestay",
          "20:00  (Optional) Thả đó, thả lưới — fishing on the Da River lake",
          "Overnight at Mường Lay homestay",
        ],
      },
      {
        day: 2,
        ...
        slots: [
          ...
          "18:30  Dinner — Da River specialties at the homestay",
          "Overnight at Pa Phông · beside the Da River",
        ],
      },
      {
        day: 3,
        title: "Day 3 — Pa Phông → Boat on Da River → Lao Chải 1 → Thác Tác Tình → Sì Thâu Chải Village   90km",
        slots: [
          "07:30  Breakfast at Pa Phông · photography at the bridge",
          "09:00  Board the boat — Da River lake crossing (Điện Biên → Lai Châu)",
          "11:30  Arrive Lao Chải 1 · lunch at the village",
          "13:30  Continue by road toward Thác Tác Tình",
          "14:00  Thác Tác Tình waterfall",
          "17:00  Arrive Sì Thâu Chải Village · sunset over the Lai Châu valley",
          "18:30  Dinner with the Red Dao community · sing and dance with locals",
          "22:00  Depart Sì Thâu Chải Village → overnight return to Hanoi",
        ],
      },
    ],
    ...
    faqs: [
      { q: "Where does the tour start and end?", a: "Departs Hanoi at 22:00 the night before Day 1 (overnight van to Tam Đường). Returns to Hanoi the morning after Day 3 (overnight van from Sì Thâu Chải Village). Net time away from Hanoi: 3 days, 2 nights, plus two overnight travel periods." },
    ...
    welcomePack: {
      ...DEFAULT_WELCOME_PACK,
      intro: "Your host hands you a Morning Vietnam pack at San Thàng market on the first morning in Tam Đường. One item was put there for three days of northwest mountain roads.",
    },
    ...
    itinerary: [
      {
        ...
        slots: [
          ...
          "18:30 – 20:30  Dinner cooked by the host family · Northwest of Vietnam style",
  ...
  // ── Unlock Lai Châu ──────────────────────────────────────────────────────
  {
    ...
    highlights: [
      ...
      "Overnight at Sì Thâu Chải Village — Dao village homestay above the clouds",
    ...
    included: [
      ...
      "Homestay at Sì Thâu Chải Village (Local Dao homestay)",
    ...
    tripInfo: {
      "car": [
        ...
        { icon: "tools-kitchen-2", label: "Meals",             value: "Breakfast + lunch + dinner × 2 days" },
        { icon: "home",            label: "Accommodation",     value: "Local Dao Homestay · Sì Thâu Chải Village" },
        { icon: "mountain",        label: "Max altitude",      value: "1,250m · Linh Ứng Temple" },
    ...
    itinerary: [
      ...
      },
      {
        ...
        slots: [
          ...
          "15:00  Drive to Sì Thâu Chải Village (15 min)",
    ...
    valueAnchor: {
      ...
      paragraphs: [
        "The price includes both sleeper buses, private car or motorbike for two full days, all meals from Day 1 breakfast through Day 2 dinner, homestay at Sì Thâu Chải Village, hotel (arrival morning and departure night), all entrance fees, motorbike taxi into the Nậm Lúc jungle, full-day host, Unlock Challenge, and welcome pack.",
      ...
      compareTable: [
        ...
        { metric: "Villages",           typical: "Tourist villages with gift shops",    us: "Lao Chải 1 + Sì Thâu Chải Village — no tourist infrastructure" },
        { metric: "Overnight",          typical: "Hotel in Sa Pa",                      us: "Local Dao homestay · Sì Thâu Chải Village" },
    ...
    elevationProfile: [
      ...
      { time: "15:15", label: "Sì Thâu Chải Village · Sunset",          elevation: 1450, icon: "hike",     highlight: true,  day: 1 },
    ...
    activityCards: [
      ...
      },
      {
        ...
        desc: "A working H'Mông community in the valley below Sì Thâu Chải Village — not a display village, not on any coach tour route. Your local host walks you through the rhythms of daily life: the forge, the fields, the weavers. Lunch is cooked in the village and eaten with the family.",
        highlight: false,
      },
      {
        ...
        title: "Thác Tác Tình",
        desc: "A waterfall in a narrow valley gorge at 1,000m — the water comes off the ridge above Sì Thâu Chải Village and drops into a pool cold enough to stop conversation. The hike in is 30 minutes through scrub forest. The swim is the reward.",
        highlight: false,
      },
      {
    ...
    seasonality: {
      ...
      notes: [
        { title: "Best conditions (Oct – Apr)", desc: "Dry trails, clear skies, and the best light for the homestay sunrise at Sì Thâu Chải Village. October–November the rice terraces in the valley are golden. January–February the air is crisp and the cave system is at its most atmospheric." },
    ...
    faqs: [
      ...
      { q: "What is the homestay like at Sì Thâu Chải Village?", a: "A Local Dao family homestay — traditional house, communal dinner, shared sleeping area (mattresses on platform beds with blankets). No luxury. Running water and a basic bathroom. The dinner, the happy water, and the sunrise from the terrace are the experience." },
      ...DEFAULT_FAQS.slice(2),
    ],
