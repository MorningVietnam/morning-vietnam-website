...
export const tours: Tour[] = [
  ...
  // ── Lai Châu Loop ────────────────────────────────────────────────────────
  {
    ...
    tripInfo: {
      "self-ride": [
        { icon: "map-pin",         label: "Pickup",     value: "Hanoi · Sa Pa · or Hà Giang — 22:00 the night before Day 1" },
        { icon: "users",           label: "Group size", value: "Max 14 people · private departure from 3+" },
        { icon: "car",             label: "Transport",  value: "Overnight van to/from route · your own motorbike on route · boat Day 3" },
        { icon: "tools-kitchen-2", label: "Meals",      value: "3 breakfasts · 3 lunches · 3 dinners" },
      ...
      "easy-rider": [
        { icon: "map-pin",         label: "Pickup",     value: "Hanoi · Sa Pa · or Hà Giang — 22:00 the night before Day 1" },
        { icon: "users",           label: "Group size", value: "Max 14 people · private departure from 3+" },
        { icon: "car",             label: "Transport",  value: "Overnight van to/from route · experienced local easy-rider driver · boat Day 3" },
        { icon: "tools-kitchen-2", label: "Meals",      value: "3 breakfasts · 3 lunches · 3 dinners" },
        { icon: "home",            label: "Sleep",      value: "Night 1: Thai family homestay · Mường Lay   Night 2: Pa Phồng bridge homestay" },
        { icon: "mountain",        label: "Terrain",    value: "Mountain roads · stone plateau · Da River lake · highland forest" },
        { icon: "users",           label: "Cultures",   value: "3 ethnic groups: Thai · H'Mông · Red Dao" },
